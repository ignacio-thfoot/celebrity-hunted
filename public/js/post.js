  ...
  _createClass(Post, [{
    ...
    value: function loadTextData() {
      ...
      textElements.forEach(function (el) {
        el.innerHTML = _data_data_json__WEBPACK_IMPORTED_MODULE_3__.post[el.getAttribute("data-text")];
      });
    }
  }, {
    key: "hidePreloader",
    ...
    value: function showSignupForm(team) {
      ...
      content.innerHTML = _data_data_json__WEBPACK_IMPORTED_MODULE_3__.post.win_text;
    ...
    value: function createScore(team, timePassed) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_2___default().get('/index.php/api/scores/average/' + _data_data_json__WEBPACK_IMPORTED_MODULE_3__.teams[team]).then(function (res) {
