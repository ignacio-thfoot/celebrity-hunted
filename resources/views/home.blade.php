            ...
            <div class="b--card-c__front-items">
                ...
                <div class="b--card-c__front-items__ft">
                    <div class="b--form-checkbox-a">
                        ...
                        <label class="b--card-c__front-items__ft__label" for="checkbox2">J'accepte <a href="data/apv-celebrity-hunted-cgu-reglement.pdf" target="_blank" class="b--card-c__front-items__ft__link">les conditions du jeu concours</a></label>
                    </div>
                </div>
            </div>
