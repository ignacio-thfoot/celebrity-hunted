    ...
    <div id="pano" style="width:100%;height:100%;position:relative; z-index: 1;">
        ...
        <div class="b--card-c" id="modal-error" role="dialog">
            <div class="b--card-c__front-items">
                ...
                <div class="b--card-c__front-items__ft">
                    <a class="addthis_button_compact"><img src="img/FB.png" alt="Share" class="b--card-c__front-items__ft__social at-icon-wrapper at-share-btn at-svc-facebook"></a>
                    <a class="addthis_button_compact"><img src="img/TWITTER.png" alt="Share" class="b--card-c__front-items__ft__social at-icon-wrapper at-share-btn at-svc-twitter"></a>
